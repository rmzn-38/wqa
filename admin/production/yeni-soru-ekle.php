						...
						<form action="../netting/adminislem.php" method="POST" enctype="multipart/form-data" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
							...
							<div class="form-group">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									<input type="text" id="first-name" name="soru_soru" required="required" class="form-control col-md-7 col-xs-12">
								</div>
							</div>
							...
							<!-- Ck Editör Başlangıç -->
									...
									<div class="form-group">
										...
										<div class="col-md-6 col-sm-6 col-xs-12">
											...
											<textarea  class="ckeditor" id="editor1" name="soru_icerik"></textarea>
										</div>
									</div>
							...
							<div class="form-group">
								<div align="right" class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
									<button type="submit" name="soruekle" class="btn btn-success">Ekle</button>
								</div>
							</div>
