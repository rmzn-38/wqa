				...
				<div class="x_panel">
					...
					<div class="x_content">
						...
						<form action="../netting/adminislem.php" method="POST" enctype="multipart/form-data" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
							...
							<?php if (!empty($hakkimizdacek['hakkimizda_resimyol'])) { ?>
							...
							<div class="form-group">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									<img width="300" src="../../<?php echo $hakkimizdacek['hakkimizda_resimyol']; ?>">
								</div>
							</div>
							<?php } ?>
							...
							<div class="form-group">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									<input type="file" id="first-name"  name="hakkimizda_resimyol" class="form-control col-md-7 col-xs-12">
								</div>
							</div>
							...
							<input type="hidden" name="hakkimizda_resimyol" value="<?php echo $hakkimizdacek['hakkimizda_resimyol'] ?>">
