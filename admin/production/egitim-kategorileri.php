					...
					<div class="x_content">
						...
						<table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
							...
							<tbody>
								...
								<tr>
									<td><?php echo $say ?></td>
									<td><?php echo $egitimcek['egitim_ad']; ?></td>
									<td><?php echo $egitimcek['egitim_baslik'] ?></td>
									<td><?php echo $egitimcek['egitim_icerik'] ?></td>
									<td>
										<?php if ($egitimcek['egitim_durum']=="1") { ?>
									...
									<td class="text-center">
										...
										<a href="egitim-kategorisi-duzenle.php?egitim_id=<?php echo $egitimcek['egitim_id']; ?>">
										...
										<a onclick="return confirm('Bu ürünü silmek istediğinize emin misiniz?')" href="../netting/adminislem.php?egitim_id=<?php echo $egitimcek['egitim_id']; ?>&egitim_sil=ok">
